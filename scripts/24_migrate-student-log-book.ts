/**
 * Data Migration Script: Import student log book from CSV
 *
 * Source: AA_Student_Log_Book.csv
 *
 * Usage:
 *   npx tsx scripts/24_migrate-student-log-book.ts --dry-run
 *   npx tsx scripts/24_migrate-student-log-book.ts
 */
...
const CSV_PATH = path.join(process.cwd(), 'data', 'AA_Student_Log_Book.csv');
...
async function migrate() {
    console.log('📓 Starting student log book migration...\n');
