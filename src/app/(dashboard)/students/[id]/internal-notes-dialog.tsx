      ...
      <DialogContent className="sm:!max-w-[600px] !max-h-[92vh] !overflow-hidden !p-0 !gap-0 bg-background flex flex-col" showCloseButton={false}>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col min-h-0 flex-1">
          <div className="flex-1 overflow-y-auto px-6 py-5 space-y-5">
            ...
            <Section icon={StickyNote} title="Student Profile Notes">
              ...
              <Field label="Parent Expectations">
            ...
            <Section icon={ShieldAlert} title="Sensitive Information" accent="rose">
              <Field label="Disability / SEN">
            ...
            <Section icon={Heart} title="Additional Notes" accent="teal">
              <Field label="Guardianship Notes">
          ...
          <div className="border-t border-border bg-muted/50 px-6 py-4">
            <div className="flex items-center justify-end gap-3">
              ...
              <Button type="submit" disabled={isPending} className="min-w-[140px] gap-2 bg-primary hover:bg-primary/90 shadow-lg shadow-primary/20">
                {isPending ? <><Loader2 className="h-4 w-4 animate-spin" />Saving...</> : <><Check className="h-4 w-4" />{isEdit ? "Save Changes" : "Add Notes"}</>}
              </Button>
            </div>
          </div>
        </form>
