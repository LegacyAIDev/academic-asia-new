      ...
      <CardContent className="space-y-6">
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          <div className="space-y-2">
            ...
            <Input id="start_date" name="start_date" type="date" className={inputStyles} defaultValue={event?.start_date ?? ""} />
          </div>
          <div className="space-y-2">
            <Label htmlFor="end_date">End Date</Label>
            <Input id="end_date" name="end_date" type="date" className={inputStyles} defaultValue={event?.end_date ?? ""} />
          </div>
          <div className="space-y-2">
